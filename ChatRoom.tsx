...
import { MessageSquare, Users, Send, Copy, ArrowLeft, Check } from 'lucide-react';
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="bg-white p-8 rounded-xl shadow-sm max-w-md w-full mx-4">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-slate-800 mb-2">Join Chat Room</h2>
          ...
          <button
            onClick={() => navigate('/')}
            className="mt-4 text-slate-500 hover:text-slate-700 flex items-center justify-center space-x-2 w-full transition-colors"
          >
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-600">
                {getOnlineParticipants().length} of {participants.length} participants online
              </p>
            </div>
          ...
          {chatLoading ? (
            ...
            messages.map((message) => (
              <div key={message.id} className="group">
                <div className={`flex ${message.user_name === userName ? 'justify-end' : 'justify-start'}`}>
